    ...
    def remove_permutation_symmetries(self, parameters_vectors, bias=True):
        ...
        for si, pi in zip(sorting_indices, permutation_indices):
            for i in range(len(result_parameters_vectors)):
                ...
                # hack
                kernel_indices_shaped = kernel_indices.reshape((-1, len(indices_sorted)))
                following_kernel_indices_shaped = following_kernel_indices.reshape((len(indices_sorted), -1))
                # hack end
                ...
                result_parameters_vector[kernel_indices] = result_parameters_vector[kernel_indices_shaped[:, indices_sorted].flatten()]
                #result_parameters_vector[following_kernel_indices] = result_parameters_vector[following_kernel_indices][indices_sorted]
                result_parameters_vector[following_kernel_indices] = result_parameters_vector[following_kernel_indices_shaped[indices_sorted].flatten()]
